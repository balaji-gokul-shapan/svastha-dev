...
// Flattens a Laravel-style validation error payload
// ({ message, errors: { field: [messages] } }) into one readable line so
// toasts show exactly WHICH field the backend rejected on a 422.
